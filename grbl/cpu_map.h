...
#define cpu_map_h
  ...
  #define Z_STEP_BIT      0  // Uno Digital Pin 4
  ...
  #define STEPPERS_DISABLE_BIT    5  // Uno Digital Pin 8
  ...
  #define CONTROL_RESET_BIT         6  // Uno Analog Pin 0
  #define CONTROL_FEED_HOLD_BIT     6  // Uno Analog Pin 1
  #define CONTROL_CYCLE_START_BIT   6  // Uno Analog Pin 2
  #define CONTROL_SAFETY_DOOR_BIT   6  // Uno Analog Pin 1 NOTE: Safety door is shared with feed hold. Enabled by config define.
